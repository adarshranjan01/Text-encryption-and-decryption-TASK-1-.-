...
def Result():
    ...
    if (i==1):
        ...
        messagebox.showinfo('TASK 1', 'Please Choose one of Encryption or Decrption. Try again.')
...
wn.title(" Text Encrypt and Decrypt  with TASK 1")
